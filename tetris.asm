...
.data 
    ...
    seconds db 0  ;?ï¿½ï¿½ VARIABLE EN EL SEGMENTO DE DATOS.   
    block_is_free db 0  
...
;OBTENER LA HORA DEL SISTEMA.
  mov  ah, 2ch
  int  21h      ;?ï¿½ï¿½ SEGUNDOS DE RETORNO EN DH.
;COMPRUEBE SI HA PASADO UN SEGUNDO. 
  cmp  dh, seconds  ;?ï¿½ï¿½ SI LOS SEGUNDOS SON IGUALES...
  je   delaying     ;    ...seguimos en los mismos segundos.
  mov  seconds, dh  ;?ï¿½ï¿½ SEGUNDOS CAMBIADOS. PRESERVE NUEVOS SEGUNDOS.
  ret
delay endp
delay_2 proc
    mov delay_counter, 1
...
genrate_random_number_init proc
   ...
   INT 1AH      ; CX:DX ahora conserva el n�mero de ticks del reloj     
   mov  ax, dx
   xor  dx, dx
   mov  cx, 5    
